...
>
  ...
  <span class="min-w-0 flex-1">
    ...
    <span class="block text-xs text-carvao/60"
      >安装 <b>谷歌翻译</b> 并下载 <b>意大利语</b> 离线包——用摄像头当场读懂菜单、标签和表格。</span
    >
  </span>
          ...
          <div class="space-y-1.5">
            ...
            {#if quizDoEpisodio[ep.id] && ep.partes.some((p) => p.pronta)}
              ...
              >
                ...
                <span class="flex-1 text-sm font-medium">本集测验</span>
...
<section class="mt-8">
  <div class="card p-4">
    ...
    <p class="mb-3 text-sm text-carvao/60">
      生成一个代码发给对方，合并你们两人的学习进度——无需账户，无需服务器。
    </p>
