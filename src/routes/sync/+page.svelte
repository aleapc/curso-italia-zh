...
<div class="mt-10 text-center">
  ...
  {:else if estado === 'preview'}
    <h1 class="text-2xl font-extrabold">同步？🔄</h1>
    <p class="mt-2 text-carvao/70">
      此代码包含 {previa?.ale ?? 0} + {previa?.dea ?? 0} 个已完成的部分。导入会合并所有内容，不会删除任何内容。
    </p>
  ...
  {:else if estado === 'fora'}
    <h1 class="text-2xl font-extrabold">就快好了 📲</h1>
    <p class="mx-auto mt-2 max-w-sm text-carvao/70">
      此链接在你的<b>浏览器</b>中打开——但你的学习进度保存在主屏幕上的 <b>Dimmi! 应用</b>里。请复制代码并粘贴到应用中：
    </p>
    <ol class="mx-auto mt-3 max-w-sm space-y-1 text-left text-sm text-carvao/70">
      <li>1. 点击下方的<b>复制代码</b></li>
      <li>2. 打开主屏幕上的 <b>Dimmi!</b> 应用（在电脑上：打开课程主页）</li>
      <li>3. 在<b>同步</b>处粘贴并导入</li>
    </ol>
